#include <diamond/semantics/Naive.hpp>

bool diamond::Naive::needsFunc()
{
  return true;
}

void diamond::Naive::solve()
{
  // clingo 1
  ...
  lib2.solve(std::bind(&diamond::Naive::printResult,this,std::placeholders::_1),{});
}
